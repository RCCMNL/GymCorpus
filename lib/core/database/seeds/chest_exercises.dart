...
const chestExercises = [
  ...
  ExercisesCompanion(
    ...
    focusArea: Value(
      'Pettorali (sterno-costale), Tricipiti, Deltoidi anteriori',
    ),
    preparation: Value(
  ...
  ExercisesCompanion(
    ...
    focusArea: Value(
      'Pettorali (allungamento), Gran Dorsale, Serrato anteriore',
    ),
    preparation: Value(
  ...
  ExercisesCompanion(
    ...
    focusArea: Value(
      'Pettorali (contrazione isometrica, focus interno/sterno)',
    ),
    preparation: Value(
