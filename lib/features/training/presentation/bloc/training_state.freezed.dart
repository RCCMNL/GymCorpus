...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrainingState);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( TrainingLoading value)?  loading,TResult Function( TrainingLoaded value)?  loaded,TResult Function( TrainingError value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
case TrainingLoading() when loading != null:
return loading(_that);case TrainingLoaded() when loaded != null:
return loaded(_that);case TrainingError() when error != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( TrainingLoading value)  loading,required TResult Function( TrainingLoaded value)  loaded,required TResult Function( TrainingError value)  error,}){
final _that = this;
switch (_that) {
case TrainingLoading():
return loading(_that);case TrainingLoaded():
return loaded(_that);case TrainingError():
return error(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( TrainingLoading value)?  loading,TResult? Function( TrainingLoaded value)?  loaded,TResult? Function( TrainingError value)?  error,}){
final _that = this;
switch (_that) {
case TrainingLoading() when loading != null:
return loading(_that);case TrainingLoaded() when loaded != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrainingLoading);
}
...
@JsonKey() List<RoutineEntity> get routines {
...
@JsonKey() List<WorkoutSetEntity> get weightLogs {
...
@JsonKey() List<WorkoutSessionEntity> get workoutSessions {
...
@JsonKey() List<BodyWeightLogEntity> get bodyWeightLogs {
  if (_bodyWeightLogs is EqualUnmodifiableListView) return _bodyWeightLogs;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_bodyWeightLogs);
}

 final  List<BodyMeasurementEntity> _bodyMeasurements;
@JsonKey() List<BodyMeasurementEntity> get bodyMeasurements {
...
@JsonKey() List<CardioSessionEntity> get cardioSessions {
...
@JsonKey() Map<String, String> get settings {
...
$TrainingLoadedCopyWith<TrainingLoaded> get copyWith => _$TrainingLoadedCopyWithImpl<TrainingLoaded>(this, _$identity);
...
/// @nodoc
abstract mixin class $TrainingLoadedCopyWith<$Res> implements $TrainingStateCopyWith<$Res> {
...
as List<RoutineEntity>,weightLogs: null == weightLogs ? _self._weightLogs : weightLogs // ignore: cast_nullable_to_non_nullable
as List<WorkoutSetEntity>,workoutSessions: null == workoutSessions ? _self._workoutSessions : workoutSessions // ignore: cast_nullable_to_non_nullable
as List<WorkoutSessionEntity>,bodyWeightLogs: null == bodyWeightLogs ? _self._bodyWeightLogs : bodyWeightLogs // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TrainingErrorCopyWith<TrainingError> get copyWith => _$TrainingErrorCopyWithImpl<TrainingError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrainingError&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $TrainingErrorCopyWith<$Res> implements $TrainingStateCopyWith<$Res> {
  factory $TrainingErrorCopyWith(TrainingError value, $Res Function(TrainingError) _then) = _$TrainingErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
