...
/// Cosa si scrive dove il catalogo non ha ancora niente da dire.
///
/// Prima al posto vuoto ci finiva la descrizione di un crunch - "solleva le
/// spalle da terra contraendo gli addominali" - qualunque esercizio si
/// stesse guardando.
const _noInstructions = 'Nessuna indicazione salvata per questo esercizio.';

/// Il corpo della scheda esercizio: attrezzatura e focus, preparazione,
/// esecuzione, consigli e le note dell'utente.
class ExerciseGuide extends StatelessWidget {
  const ExerciseGuide({required this.exercise, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final phases = ExecutionPhases.fromText(exercise.execution);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _NumberedList(content: exercise.preparation ?? _noInstructions),
            ...
            children: [
              Expanded(
                child: _ExecutionCard(
                  title: 'La Salita',
                  content: phases.up ?? _noInstructions,
                  label: 'UP',
                  color: theme.colorScheme.tertiary,
                ),
              ),
              ...
              Expanded(
                child: _ExecutionCard(
                  title: 'La Discesa',
                  content: phases.down ?? _noInstructions,
                  label: 'DOWN',
          ...
          // Tips
          _ExpertTipsCard(tip: exercise.tips ?? _noInstructions),
