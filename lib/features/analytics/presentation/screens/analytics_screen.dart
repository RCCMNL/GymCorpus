...
class _DailyStepsSection extends StatefulWidget {
  const _DailyStepsSection();

  @override
  State<_DailyStepsSection> createState() => _DailyStepsSectionState();
}

class _DailyStepsSectionState extends State<_DailyStepsSection> {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Collega Google Fit o Apple Health per visualizzare passi, distanza e calorie.',
                    style: theme.textTheme.bodySmall?.copyWith(
                      color: theme.colorScheme.outline,
                      height: 1.4,
                    ),
