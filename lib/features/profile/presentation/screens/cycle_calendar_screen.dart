...
class _CycleCalendarScreenState extends State<CycleCalendarScreen>
  ...
  final Map<CyclePhase, Map<String, dynamic>> _phaseData = {
    CyclePhase.menstrual: {
      ...
      'advice':
          'Ottimo per il recupero attivo, yoga dolce e camminate. Ascolta il tuo corpo.',
    ...
    CyclePhase.follicular: {
      ...
      'advice':
          'Perfetto per aumentare i carichi, HIIT e allenamenti ad alta intensità!',
    ...
    CyclePhase.ovulatory: {
      ...
      'advice':
          'Picco di energia! Tenta i tuoi massimali (PR) o sfide impegnative.',
      'icon': Icons.local_fire_department_rounded,
    },
    CyclePhase.luteal: {
      'name': 'Fase Luteale',
      'color': const Color(0xFFF0A8D0),
      'advice':
          'L energia inizia a calare. Concentrati su forza a media intensità o pilates.',
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: const Text(
                      "Dati non salvati: questa è un'anteprima interattiva.",
                    ),
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: _isPeriodActive
              ...
              child: Text(
                _isPeriodActive ? 'SEGNA FINE CICLO' : 'SEGNA INIZIO CICLO',
                style: TextStyle(
