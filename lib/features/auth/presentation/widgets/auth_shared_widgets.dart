...
class AmbientBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Stack(
    children: [
      ...
      Positioned(
        top: -120,
        right: -80,
        child: _g(350, theme.colorScheme.primary, 0.18),
      ),
      Positioned(
        top: 90,
        left: -110,
        child: _g(260, theme.colorScheme.tertiary, 0.08),
      ),
      Positioned(
        bottom: -100,
        left: -60,
        child: _g(300, theme.colorScheme.secondary, 0.09),
      ),
      Positioned(
        bottom: 140,
        right: -40,
        child: _g(210, theme.colorScheme.primaryContainer, 0.12),
      ),
      Positioned.fill(
        child: IgnorePointer(
          child: DecoratedBox(
  ...
  Widget _g(double s, Color c, double a) => Container(
    width: s,
    height: s,
    decoration: BoxDecoration(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                t.colorScheme.surfaceContainerHigh.withValues(alpha: 0.9),
                t.colorScheme.primaryContainer.withValues(alpha: 0.22),
            ...
            boxShadow: [
              ...
              BoxShadow(
                color: t.colorScheme.tertiary.withValues(alpha: 0.06),
                blurRadius: 34,
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: TextStyle(color: t.colorScheme.outline),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          side: BorderSide(
            color: t.colorScheme.tertiary.withValues(alpha: 0.28),
          ),
        ),
        child: isLoading
            ? const SizedBox(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                t.colorScheme.surfaceContainerHigh.withValues(alpha: 0.92),
                t.colorScheme.primaryContainer.withValues(alpha: 0.18),
              ],
            ),
            border: Border.all(
...
Widget authLabel(ThemeData t, String s) => Padding(
...
Widget authDivider(ThemeData t, String s) {
  final l = Expanded(
    child: Container(
      height: 1,
